      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-arc-500/10 border border-arc-500/20 text-arc-400 text-sm font-medium mb-8">
      ...
      <footer className="border-t border-arc-500/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-slate-600">© 2026 ArcFlow. Built on ARC.</p>
          </div>
        </div>
      </footer>
    </div>
